...
- [Create Namespaced Custom Claims](https://auth0.com/docs/tokens/create-namespaced-custom-claims)

## Spezifikation
- [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html)
- [Claims (user info)](https://connect2id.com/learn/openid-connect#claims)
